 ...
 */
export type InternalAuthBasedEngine = PublicAuthBasedEngine | 'PlayDialogArabic' | 'PlayDialogHindi' | 'PlayDialogLora' | 'PlayDialogMultilingual';
export type V3InternalSettings = {
    ...
    customInferenceCoordinatesGenerator?: (engine: InternalAuthBasedEngine, userId: string, apiKey: string) => Promise<InferenceCoordinatesEntry>;
};
