...
export type PlayDialogTurboEngineStreamOptions = Omit<Play30EngineStreamOptions, 'voiceEngine' | 'outputFormat' | 'seed' | 'sampleRate' | 'temperature' | 'quality' | 'styleGuidance' | 'textGuidance' | 'voiceGuidance' | 'language'> & {
    ...
    language?: 'english';
    voiceId: 'Aaliyah-PlayAI' | 'Adelaide-PlayAI' | 'Angelo-PlayAI' | 'Arista-PlayAI' | 'Atlas-PlayAI' | 'Basil-PlayAI' | 'Briggs-PlayAI' | 'Calum-PlayAI' | 'Celeste-PlayAI' | 'Cheyenne-PlayAI' | 'Chip-PlayAI' | 'Cillian-PlayAI' | 'Deedee-PlayAI' | 'Eleanor-PlayAI' | 'Fritz-PlayAI' | 'Gail-PlayAI' | 'Indigo-PlayAI' | 'Jennifer-PlayAI' | 'Judy-PlayAI' | 'Mamaw-PlayAI' | 'Mason-PlayAI' | 'Mikail-PlayAI' | 'Mitch-PlayAI' | 'Nia-PlayAI' | 'Quinn-PlayAI' | 'Ruby-PlayAI' | 'Thunder-PlayAI';
});
/**
...
export type APISettingsInput = {
    ...
    advanced?: {
         ...
         */
        axiosClient?: <T extends AxiosRequestConfig>(reqConfig: T) => Promise<{
            headers: Record<string, string>;
            status: number;
            data: T extends {
                responseType: 'stream';
            } ? NodeJS.ReadableStream : Record<string, any>;
        }>;
    };
    /**
